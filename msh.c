 ...
 *  Description    : Minishell program capable of executing commands and job controll
 *  Objective      : Implement own Linux Shell(mini)
...
int main()
{
	...
	do
	{
		...
		if (no_ps1_prompt)
		{
			sprintf(PS1, "\033[1;32mmsh@Krish\033[0m:\033[1;34m%s\033[0m$ ", cwd);
		}
